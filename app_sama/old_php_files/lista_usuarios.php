						...
						<div class="m-stack__item m-stack__item--fluid m-header-head" id="m_header_nav">
							...
							<div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-light m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-dark m-aside-header-menu-mobile--submenu-skin-dark ">
								<ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
									<li class="m-menu__item  m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="m-menu__link m-menu__toggle" title="Non functional dummy link"><span
										...
										<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left"><span class="m-menu__arrow m-menu__arrow--adjust"></span>
											<ul class="m-menu__subnav">
												<li class="m-menu__item  m-menu__item--active " aria-haspopup="true"><a href="inner.html" class="m-menu__link "><i class="m-menu__link-icon flaticon-file"></i><span class="m-menu__link-text">Create New Post</span></a></li>
									...
									<li class="m-menu__item  m-menu__item--active m-menu__item--submenu m-menu__item--rel"><a href="lista_usuarios" class="m-menu__link"><span class="m-menu__link-title"> <span class="m-menu__link-wrap"><span class="m-menu__link-text">Clientes</span></a>
				...
				<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark ">
					...
					<div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark m-aside-menu--dropdown " data-menu-vertical="true" m-menu-dropdown="1" m-menu-scrollable="0" m-menu-dropdown-timeout="500">
						<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
							...
							<li class="m-menu__item  m-menu__item--submenu m-menu__item--open m-menu__item--expanded" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><span class="m-menu__item-here"></span><i
									 class="m-menu__link-icon flaticon-layers"></i><span class="m-menu__link-title"> <span class="m-menu__link-wrap"> <span class="m-menu__link-text">Reports</span> <span class="m-menu__link-badge"><span class="m-badge m-badge--danger">2</span></span>
								...
								<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item  m-menu__item--active" aria-haspopup="true"><a href="inner.html" class="m-menu__link "><i class="m-menu__link-icon flaticon-pie-chart"></i><span class="m-menu__link-text">Finance Reports</span></a></li>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Usuários Cadastrados</h3>
							</div>
						</div>
					</div>
					...
					<!-- END: Subheader -->
					<div class="m-content">
						<table class="table table-light table-user-list table-bordered">
							<thead class="thead-dark">
								<tr>
									<th width="80" class="text-center">#</th>
									<th>Dados usuário</th> <!-- Foto, Nome e Email -->
							...
							<tbody>
								<?php
									  ...
									  if($sql->rowCount() > 0){
										  foreach($sql->fetchAll() as $dadoUsuario){
											  echo "<tr>";
											  echo "<td class='num-user text-center'><span>".$dadoUsuario['id'].".</span></td>";
											  echo "<td><span class='avatar_table'><img src='images/users/".$dadoUsuario['avatar']."'/></span><span class='nome-email-user'><span class='nome-user'>".$dadoUsuario['nome']."</span><span class='email-user'>".$dadoUsuario['email']."</span></span></td>";
											  echo "<td class='text-center'>".$dadoUsuario['telefone']."</td>";
											  echo "<td class='text-center'><div class='opcoes-user'><i class='fas fa-bars'></i>
											  		 <ul class='sub-opcoes shadow-sm bg-white' style='display:none; list-style:none;'>
													 <li><a href='config/editar_user.php?id={$dadoUsuario['id']}'><i class='far fa-edit'></i> Editar</a></li>
													 <li><a class='excluir-usuario' onclick='confirmDel({$dadoUsuario['id']})' href='javascript:;'><i class='far fa-trash-alt'></i> Excluir</a></li>
													 </ul>
											  </div></td>";
											  echo "</tr>";
										  }
